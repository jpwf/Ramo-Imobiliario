...
import { Box, Button, createTheme, Stepper, Typography } from '@mui/material'
        ...
        <div className='w-full items-center justify-center'>
            <Stepper activeStep={activeStep}>
                <Box className={theme.Boxstyle}>
                    ...
                    <Box >
                        <Typography className={theme.instructions}>
